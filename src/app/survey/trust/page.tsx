...
const questions = getQuestionsByGroup('TRUST')
...
export default function TrustPage() {
  ...
  const handleNext = () => {
    ...
    router.push('/survey/satisfaction')
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-slate-800">{GROUP_TITLES.TRUST}</p>
            </div>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-4">
        <SurveyProgress currentStep={6} totalSteps={9} label={GROUP_TITLES.TRUST} />
      </div>
