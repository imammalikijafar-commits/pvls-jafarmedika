...
const questions = getQuestionsByGroup('SATISFACTION')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-slate-800">{GROUP_TITLES.SATISFACTION}</p>
            </div>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-4">
        <SurveyProgress currentStep={7} totalSteps={9} label={GROUP_TITLES.SATISFACTION} />
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 pb-32">
        ...
        >
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
            {GROUP_TITLES.SATISFACTION}
          </h1>
          <p className="text-sm text-slate-500 max-w-lg mx-auto leading-relaxed">
            {GROUP_DESCRIPTIONS.SATISFACTION}
          </p>
        </motion.div>
        ...
        <div className="space-y-4">
          {questions.map((q, idx) => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.05 + idx * 0.05, duration: 0.35, ease: EASE_OUT }}
            >
              <QuestionCard
                code={q.code}
                text={q.text}
        ...
        <div className="flex items-center justify-between gap-3 pt-6">
          <Button
            type="button"
            variant="outline"
            onClick={() => router.push('/survey/trust')}
